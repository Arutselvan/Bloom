...
<html lang="en">
  <head>
    <title>LearnLab{% block title %}{% endblock title %}</title>
    <meta charset="UTF-8"/>
  ...
  <body>
    ...
    <div class="container">
      <div class="page-header">
          <a class="btn btn-lg btn-info pull-right" href="{% url 'logout_view' %}"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> Logout</a><a class="btn btn-lg btn-warning pull-right" href="#search"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> Find</a><a class="btn btn-lg btn-danger pull-right" href="{% url 'qa_create_question' %}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Ask Question</a><h1><a href="{% url 'qa_index' %}"><img width="50px" src="http://icons.iconarchive.com/icons/seanau/flat-app/256/Questionmark-icon.png" /><orange>LearnLab</orange> </a><small>Open Questions</small></h1>
      </div>
    </div>
