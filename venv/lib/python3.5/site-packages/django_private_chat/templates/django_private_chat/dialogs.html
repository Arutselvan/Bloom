                ...
                <div class="messages-container">
                    <div id="messages" class="messages">
                        {% for msg in active_dialog.messages.all %}
                            <div class="row"
                                 data-id="{{ msg.id }}">
                                <p class="{% if msg.sender == request.user %}pull-left user-msg{% else %}pull-right opponent-msg{% endif %}">
        ...
        $(document).ready(function () {
            ...
            function addNewMessage(packet) {
                ...
                if (packet['sender_name'] == $("#owner_username").val()) {
                    msg_class = "pull-left user-msg";
                } else {
                    msg_class = "pull-right opponent-msg";
                }
                var msgElem =
                    $('<div class="row" data-id="' + packet.message_id + '">' +
                        '<p class="' + msg_class + '">' +
