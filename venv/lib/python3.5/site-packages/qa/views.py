...
class CreateQuestionView(LoginRequired, CreateView):
    ...
    def post(self, request, **kwargs):
        ...
        concepts = knowledge_extractor.get_concepts(request.POST.get('title') + '. ' + request.POST.get('description'))
        for concept in concepts:
            new_tags += ',{0}'.format(concept.get('text'))

        request.POST = request.POST.copy()
        request.POST['tags'] = new_tags
        return super(CreateQuestionView, self).post(request, **kwargs)
